...
$config['SITE_PATH'] = realpath('..').'/inmovitek/';
$config['PROTECTED_FOLDER'] = 'protected/';
$config['BASE_PATH'] = realpath('..').'/dooframework/';

$config['APP_NAME'] = 'Inmovitek';
$config['API_IPINFODB'] = '964d7c4884050df37e29df6dcc1741bd92082ee7561de87ef366631a3b56bd4e';
$config['NUM_INMUEBLES_RESULTADOS'] = 10;
