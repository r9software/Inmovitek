                ...
                <div class="container_12">
                        ...
                        jQuery(document).ready(function($) {
                            ...
                            <div class="re-details">
                                ...
                                <ul class="split_list">
                                    ...
                                    <li><strong>Mestros cuadrados: </strong><?php echo $inmueble->metros_cuadrados; ?></li>
                                    ...
                                    <li><strong>Alberca: </strong><?php if ($inmueble->alberca)
                                echo 'Si';
                            else
                                echo 'No';
                            ?></li>
                                    <li><strong>Cochera: </strong><?php if ($inmueble->cochera)
                                            echo 'Si. Con espacio para ' . $inmueble->num_autos_cochera . ' veh&iacute;culos';
                                        else
                                            echo 'No';
                            ?></li>
                                </ul>
                    ...
                    <div class="grid_4 sidebar">
                        ...
                        <div class="widget-container widget_adv_filter">
                            <h3 class="widget-title">Contacte al vendedor:</h3>

                            <form action="#" method="get" class="form_white agent_form">

                                <div class="row">
                                    <label class="label_title">Nombre:</label>
                                    <input type="text" name="nombre" class="inputField" placeholder="Nombre">
                                </div>

                                <div class="row">
                                    <label class="label_title">Paellido:</label>
                                    <input type="text" name="apellido" class="inputField" placeholder="Apellido">
                                </div>

                                <!-- <div class="row input_styled inlinelist">
                                     <label class="label_title">Como desea ponerse en contacro:</label><br>
                                ...
                                <div class="row">
                                    ...
                                    <input type="text" name="email" class="inputField" placeholder="email" required="required">
                                </div>

                                <div class="row">
                                    <label class="label_title">Tel&eacute;fono:</label>
                                    <input type="text" name="telefono" class="inputField" placeholder="Telefono">
                                </div>

                                <div class="row">
                                    <label class="label_title">Mensaje*:</label>
                                    <textarea rows="4" cols="5" name="mensaje" class="textareaField">I would like to inquire about  the property at 5012 Sea Chase Street San Diego, CA 92130.</textarea>
                                </div>

                                <div class="row input_styled rowCheck">
                                    <input type="checkbox" name="newsletter_subscribe" id="newsletter_subscribe" value="1" checked> <label for="newsletter_subscribe">Suscribase al boletin de noticias</label>

                                    <input type="submit" value="Contactar vendedor" class="btn-submit">
                                </div>

                            </form>            

                            <div class="agent_phone">
                                <span>O si lo prefiere llamelo</span>
