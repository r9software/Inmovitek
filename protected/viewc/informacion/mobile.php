...
<html lang="en" class="no-js">
	...
	<head>
		...
		<title><?php echo Doo::conf()->APP_NAME; ?> M&oacute;vil</title>
						...
						<div class="post-list">
							...
							<div class="post-detail">
								<div class="post-title">
									<h2><?php echo Doo::conf()->APP_NAME; ?> M&oacute;vil</h2>
								</div>
								<div class="entry">
									...
									<div id="store-logos">
										<p>Encuentra nuestra aplicaci&oacute;n para m&oacute;viles en:</p>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<img src="<?php echo Doo::conf()->APP_URL; ?>global/images/mobile/appStore.png" alt="AppSotre" width="250px">
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<img src="<?php echo Doo::conf()->APP_URL; ?>global/images/mobile/playStore.png" alt="PlayStore" width="250px">
									</div>
								</div>
							</div>
						</div>
