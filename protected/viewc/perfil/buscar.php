    ...
    <body>
        <div class="body_wrap">
            ...
            if (isset($data['wallpaper'])) {
                ?>
                <div class="header" style="background-image:url(<?php echo $data['wallpaper']; ?>);">
                    <?php
                } else {
                    ?>
                                        ...
                                        <div class="search_col_2">
                                            ...
                                            <div class="row rangeField">
                                                ...
                                                <div class="range-slider">
                                                    <input id="price_range" type="text" name="precio" value="<?php
                                            ...
                                            <div class="row rangeField rowHide">
                                                ...
                                                <div class="range-slider">
                                                    <input id="square_range" type="text" name="metros_cuadrados" value="<?php
                                                    if (isset($_GET['metros_cuadrados']))
                                                        echo $_GET['metros_cuadrados'];
                                                    else
                                                        echo '0;4000';
                                                    ?>">
                                                </div>
                                    ...
                                    <div class="inner">
                                        ...
                                        <div class="pages">
                                            ...
                                            if (isset($data['paginaActual']) && ($data['paginaActual'] > 1)) {
                                                if (isset($data['urlAnterior']))
                                                    $paginacion .= '<a href="' . $data['urlAnterior'] . '" class="link_prev">Anterior</a>';
                                            } else {
                                            ...
                                            if (isset($data['paginaActual']) && ($data['paginaActual'] == $numPaginas)) {
                                                ...
                                                if (isset($data['urlSiguiente']))
                                                    $paginacion .= '<a href="' . $data['urlSiguiente'] . '" class="link_next">Siguiente</a>';
                                            }
                                            echo $paginacion;
                                            ?>
                                        </div> 
