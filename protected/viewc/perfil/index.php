    ...
    <body>
        ...
        if (isset($_GET['save']) && $_GET['save'] == 'success') {
            ...
            <div id="message" class="bodyMessage-content">
                <h1>Cambios en su perfil guardados</h1>
                <hr />
                <p>Se ha actualizado el perfil de su inmobiliaria.</p>
                <br />
                ...
                <div class="header" style="background-image:url(<?php echo $data['wallpaper']; ?>);">
                    ...
                    <div class="header_inner">
                        <div class="container_12">
                            ...
                            <?php include(Doo::conf()->SITE_PATH . 'protected/viewc/perfil/elements/header_top.php'); ?>
