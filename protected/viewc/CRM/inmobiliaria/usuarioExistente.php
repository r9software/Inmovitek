...
<html lang="en" class="no-js">
    ...
    <body>
                ...
                <?php 
                    switch($_GET['error']){
                        case 'incompleto':
                            ...
                            break;
                        case 'mailExist':
                            echo 'Ya existe un usuario registrado con ese correo electr&oacute;nico. Intente con un correo diferente.';
                            break;
                        case 'passwd':
        ...
        <div id="message" class="bodyMessage-content">
            ...
            <hr />
            <p>La informaci&oacute;n del usuario fue actualizada correctamente.</p>
            <br />
            <div class="boton-cerrar" id="message-close">
                <a href="#" class="button_link" onclick="cerrarVentanaInformacion();"><span>Cerrar</span></a>
            </div>
            ...
            <div class="middle">
                <div class="container_12">
                    ...
                    <div class="grid_8 content">
                        <h2>Modifique un asesor de ventas</h2>
                        <p>Para modificar un  asesor de ventas llene el siguiente formulario:</p>
                        <div class="comment-form">
                            <form action="#" method="post" name="formulario">
                                <div class="row">
                                    <label for="Nombre"><strong>Nombre:</strong></label>
                                    <input type="text" value="<?php echo $usuarios->nombres; ?>" name="nombre" class="inputtext input_middle required" placeholder="Nombre" required="required">
                                </div>

                                <div class="row alignleft">
                                    <label for="apaterno"><strong>Apellido Paterno:</strong></label>
                                    <input type="text" value="<?php echo $usuarios->apellido_p; ?>" name="apaterno" class="inputtext input_middle required" placeholder="Apellido paterno" required="required">
                                </div>
                                <div class="space"></div>
                                <div class="row alignleft">
                                    <label for="Apellido Materno"><strong>Apellido materno:</strong></label>
                                    <input type="text" value="<?php echo $usuarios->apellido_m; ?>" name="amaterno" class="inputtext input_middle required" placeholder="Apellido materno" required="required">
                                </div>
                                <div class="row alignleft">
                                    <label for="cp"><strong>Correo electr&oacute;nico:</strong></label>
                                    <input type="text" value="<?php echo $usuarios->correo; ?>" name="email" class="inputtext input_full required" placeholder="e-mail" required="required">
                                </div>
                                <br />

                                <div class="row alignleft">
                                    <label for="contrasenia"><strong>Contrase&ntilde;a:</strong> (S&oacute;lo si desea cambiarla)</label>
                                ...
                                <br />
                                <div class="row">
                                    <a href="#" class="button_link" onclick="document.formulario.submit();"><span>Actualizar asesor de ventas</span></a>
                                </div>
                            </form>
                        </div>
