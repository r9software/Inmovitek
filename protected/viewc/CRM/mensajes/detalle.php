                            ...
                            <div class="post-detail">
                                ...
                                <div class="comment-form">
                                    <fieldset id="toggle">
                                        ...
                                        <?php if($data['tipo']=='usuario') echo "<strong>Usuario:</strong> "; else echo "<strong>Inmobiliaria: </strong>"; ?><?if($data['tipo']=='usuario')echo $data['mensajeInmobiliaria'][0]->usuario->correo; else echo $data['mensajeInmobiliaria'][0]->inmobiliaria->nombre;?>
                                        <br>
                                ...
                                <h3>Responder</h3>
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="text" name="nombre" value="<?if($data['tipo']=='usuario')echo $data['mensajeInmobiliaria'][0]->usuario->correo; else echo $data['mensajeInmobiliaria'][0]->inmobiliaria->nombre;?>" class="inputtext input_full required" placeholder="Nombre" required="required">
                                        </div>
                                        <div class="row">
