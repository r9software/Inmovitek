                            ...
                            <div class="post-detail">
                                ...
                                <div class="comment-form">
                                    ...
                                    if(count($data['mensajeInmobiliaria'])>0){?>
                                        ...
                                        <thead>
                                        <tr>
                                            <th colspan="5">Ultimos Mensajes</th>
                                        </tr>
                                        ...
                                        for($x=0;$x<count($data['mensajeInmobiliaria']); $x++){?>
                                            ...
                                            <tr><td><input type="checkbox" id="<?echo $data['mensajeInmobiliaria'][$x]->id_mensaje; ?>" name=""></td>
                                                ...
                                                <td>
                                                	<?if($data['tipo']=='usuario')echo $data['mensajeInmobiliaria'][$x]->usuario->correo; else echo $data['mensajeInmobiliaria'][$x]->inmobiliaria->nombre;?>
                                            			
                                            	
                                            	</td>
                                                <td><a href="<?php echo Doo::conf()->APP_URL ?>CRM/<?echo  $data['tipo']?>/mensajes/detalle?id=<? echo $data['mensajeInmobiliaria'][$x]->id_mensaje;?>" >
                                                ...
                                                <td>
                                            			...
                                            			<a href="<?php echo Doo::conf()->APP_URL ?>CRM/<?echo  $data['tipo']?>/mensajes/detalle?id=<? echo $data['mensajeInmobiliaria'][$x]->id_mensaje;?>" >
                                                ...
                                                <td><? if($data['mensajeInmobiliaria'][$x]->leido==0){
                                                    ?><img src="<?php echo Doo::conf()->APP_URL; ?>/global/images/icons/file_new.png" style="width: 50px; height: 50px; margin-left: 0px; margin-right: 0px; margin-top: 0px;">
                                                <?}?>
                                            </tr>
